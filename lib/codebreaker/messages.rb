module Messages
  ...
  SELECT_ATTEMPTS = 'Please, Select the number of attempts:
#1 -  8 attempts;
#2 - 12 attempts;
#3 - 15 attempts.
...
If you want to exit type #exit'
  ...
  GAME_OVER = 'Sorry, but you loose... The code was "%s"'

  WIN = 'Yeah!!! You are absolutely wright, the code was "%s"! You WIN ;)'
...
#no   - :("
  ...
  PLAY_AGAIN_WRONG = 'Play again? Please choose #yes, #no or #save'
  ...
  LEFT_ATTEMPTS = 'Think faster. You have left %s attempts to break the code...'
end